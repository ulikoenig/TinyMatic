...
/**
 * Adapted from https://raw.githubusercontent.com/bauerca/drag-sort-listview/master/library/src/com/mobeta/android/dslv/DragSortController.java
 * to fix https://github.com/vanilla-music/vanilla/issues/202
 */

public class FixedDragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
     ...
     */
    public FixedDragSortController(DragSortListView dslv) {
        this(dslv, 0, ON_DOWN, FLING_REMOVE);
    }

    public FixedDragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
    }

    public FixedDragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode, int clickRemoveId) {
     ...
     */
    public FixedDragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode,
     ...
     * based on FixedDragSortController settings (such as remove mode).
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
        // Guard against rare case of null MotionEvents on some Samsung devices
        if (e1 == null || e2 == null) {
            return false;
        }
